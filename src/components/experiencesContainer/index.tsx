    ...
    const experiences: Experience[] = [
        {
            ...
            image: anotaisso,
            imageSide: "right",
            techs: ["JavaScript", "expressjs", "MongoDB", "GitHub"]
        },
        {
            title: "KSA (Klick System Academic) 2024.2",
            text: "The KSA academic platform aims to optimize educational management by facilitating interaction between students, teachers, and administrators. This project proposes the use of the MERN Stack (MongoDB, expressjs.js, React, Node.js) for web development and React Native for the mobile application. The choice of the MERN Stack ensures a scalable and efficient platform, using JavaScript on both the frontend and backend, which speeds up development and integration between the parties.",
            image: ksa,
            imageSide: "left",
            techs: ["React", "Nodejs", "expressjs", "MongoDB", "GitHub"]
        },
        {
            ...
            image: infinitytech,
            imageSide: "right",
            techs: ["React", "TypeScript", "Java", "SpringBoot", "GitHub"]
        },
    ];
            ...
            <div className="max-w-5xl mx-auto">
                {experiences.map((exp, index) => (
                    <ExperienceCard
                        ...
                        text={exp.text}
                        image={exp.image}
                        imageSide={exp.imageSide}
                        techs={exp.techs} // Exemplo de tecnologias, ajuste conforme necessário
                    />
                ))}
            </div>
        </section>
